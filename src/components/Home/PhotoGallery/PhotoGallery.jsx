...
import gp9 from "../../../assets/images/gallery/gp9.jpg";
const PhotoGallery = () => {
  return (
    <div>
      <PhotoProvider>
        <div className="grid grid-cols-12 place-items-stretch">
          ...
          <PhotoView src={gp9}>
            <img alt="img1" src={gp9} className="col-span-3" />
          </PhotoView>
          <PhotoView src={gp7}>
          ...
          {/* <PhotoView src={gp10}>
            <img alt="img1" src={gp10} className="col-span-3" />
          </PhotoView> */}
          <PhotoView src={gp11}>
            <img alt="img1" src={gp11} className="col-span-3" />
          </PhotoView>
          {/* <PhotoView src={gp8}>
            <img alt="img1" src={gp8} className="col-span-4" />
          </PhotoView> */}
        </div>
      </PhotoProvider>
    </div>
